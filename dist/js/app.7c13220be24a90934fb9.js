...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_335ad811_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioHistory_vue__ = __webpack_require__("cnXf");
function injectStyle (ssrContext) {
  __webpack_require__("F+CK")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-335ad811"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_335ad811_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioHistory_vue__["a" /* default */],
...
// module
exports.push([module.i, ".portfolio-history[data-v-335ad811]{min-height:100vh;background-color:var(--view-bg-theme-color);background-image:var(--view-bg-theme-gradient);display:grid;grid-template-columns:1fr 200px 200px 200px 200px 1fr;grid-template-rows:96px 32px 96px 48px -webkit-min-content;grid-template-rows:96px 32px 96px 48px min-content;grid-gap:16px;grid-template-areas:\". history-title     history-title     history-title     history-title   .\" \". history-toggle-label . . . .\" \". history-toggles   history-toggles   history-toggles   history-toggles .\" \". history-labels    history-labels    history-labels    history-labels  .\" \". transactions      transactions      transactions      transactions    .\"}@media screen and (max-width:1100px){.portfolio-history[data-v-335ad811]{grid-template-columns:.5fr minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) .5fr}}@media screen and (min-width:2000px){.portfolio-history[data-v-335ad811]{grid-template-columns:1fr 360px 360px 360px 360px 1fr}}.history-title[data-v-335ad811]{grid-area:history-title}.toggles-label[data-v-335ad811]{grid-area:history-toggle-label}.history-toggles-wrap[data-v-335ad811]{grid-area:history-toggles;grid-template-columns:1fr 1fr 1fr 1fr;grid-row:auto;display:grid}.history-toggles[data-v-335ad811]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-item-align:center;align-self:center;justify-self:center}.history-toggles button[data-v-335ad811]{width:72px;height:72px;border-radius:100px;font-size:18px;background-color:#fff}.column-labels[data-v-335ad811]{grid-area:history-labels;-ms-flex-item-align:end;align-self:end;margin-top:12px}.column-labels ul[data-v-335ad811]{display:grid;list-style:none;text-align:left;font-weight:600;grid-template-columns:1fr 1fr 1fr 1fr 1fr;padding:0 4px}.selected[data-v-335ad811]{border:3px solid var(--green)}.history-container[data-v-335ad811]{grid-template-columns:1fr 1fr 1fr 1fr 1fr;grid-auto-rows:54px;border-radius:6px;background-color:var(--card-bg-theme-color);-webkit-box-shadow:0 2px 8px 0 var(--shadow-theme-color);box-shadow:0 2px 8px 0 var(--shadow-theme-color);grid-area:transactions;padding-bottom:4px;overflow:hidden}.history-container[data-v-335ad811],.history-item[data-v-335ad811]{display:grid;-webkit-box-align:center;-ms-flex-align:center;align-items:center;text-align:left}.history-item[data-v-335ad811]{grid-template-columns:1fr 1fr 1fr 1fr 1fr;height:54px;border-bottom:1px solid rgba(0,69,102,.1);padding:4px 16px;grid-column:1/-1}.history-item>h4[data-v-335ad811]{font-weight:400}.coin-name>i[data-v-335ad811]{margin-right:4px}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioHistory.vue"],"names":[],"mappings":"AACA,oCACE,iBAAkB,AAClB,4CAA6C,AAC7C,+CAAgD,AAChD,aAAc,AACd,sDAAuD,AACvD,2DAA4D,AAC5D,mDAAoD,AACpD,cAAe,AACf,oWAK8E,CAC/E,AACD,qCACA,oCACI,mGAA2G,CAC9G,CACA,AACD,qCACA,oCACI,qDAAuD,CAC1D,CACA,AACD,gCACE,uBAAyB,CAC1B,AACD,gCACE,8BAAgC,CACjC,AACD,uCACE,0BAA2B,AAC3B,sCAAuC,AACvC,cAAe,AACf,YAAc,CACf,AACD,kCACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,8BAA+B,AAC/B,6BAA8B,AAC1B,uBAAwB,AACpB,mBAAoB,AAC5B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,2BAA2B,AACvB,kBAAkB,AACtB,mBAAoB,CACrB,AACD,yCACE,WAAY,AACZ,YAAa,AACb,oBAAqB,AACrB,eAAgB,AAChB,qBAA0B,CAC3B,AACD,gCACI,yBAA0B,AAC1B,wBAAyB,AACrB,eAAgB,AACpB,eAAgB,CACnB,AACD,mCACE,aAAc,AACd,gBAAiB,AACjB,gBAAiB,AACjB,gBAAiB,AACjB,0CAA2C,AAC3C,aAAiB,CAClB,AACD,2BACE,6BAAgC,CACjC,AACD,oCAEE,0CAA2C,AAC3C,oBAAqB,AAIrB,kBAAmB,AAEnB,4CAA6C,AAC7C,yDAA0D,AAClD,iDAAkD,AAC1D,uBAAwB,AACxB,mBAAoB,AACpB,eAAiB,CAClB,AACD,mEAfE,aAAc,AAGd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAE5B,eAAiB,CAmBlB,AAXD,+BAEE,0CAA2C,AAC3C,YAAa,AACb,0CAA8C,AAC9C,iBAAkB,AAKlB,gBAAmB,CACpB,AACD,kCACE,eAAiB,CAClB,AACD,8BACE,gBAAkB,CACnB","file":"PortfolioHistory.vue","sourcesContent":["\n.portfolio-history[data-v-335ad811] {\n  min-height: 100vh;\n  background-color: var(--view-bg-theme-color);\n  background-image: var(--view-bg-theme-gradient);\n  display: grid;\n  grid-template-columns: 1fr 200px 200px 200px 200px 1fr;\n  grid-template-rows: 96px 32px 96px 48px -webkit-min-content;\n  grid-template-rows: 96px 32px 96px 48px min-content;\n  grid-gap: 16px;\n  grid-template-areas:\n    \". history-title     history-title     history-title     history-title   .\"\n    \". history-toggle-label . . . .\"\n    \". history-toggles   history-toggles   history-toggles   history-toggles .\"\n    \". history-labels    history-labels    history-labels    history-labels  .\"\n    \". transactions      transactions      transactions      transactions    .\";\n}\n@media screen and (max-width: 1100px) {\n.portfolio-history[data-v-335ad811] {\n    grid-template-columns: 0.5fr minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) 0.5fr;\n}\n}\n@media screen and (min-width: 2000px) {\n.portfolio-history[data-v-335ad811] {\n    grid-template-columns: 1fr 360px 360px 360px 360px 1fr;\n}\n}\n.history-title[data-v-335ad811] {\n  grid-area: history-title;\n}\n.toggles-label[data-v-335ad811] {\n  grid-area: history-toggle-label;\n}\n.history-toggles-wrap[data-v-335ad811] {\n  grid-area: history-toggles;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  grid-row: auto;\n  display: grid;\n}\n.history-toggles[data-v-335ad811] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-flex-item-align:center;\n      align-self:center;\n  justify-self: center\n}\n.history-toggles button[data-v-335ad811] {\n  width: 72px;\n  height: 72px;\n  border-radius: 100px;\n  font-size: 18px;\n  background-color: #FFFFFF;\n}\n.column-labels[data-v-335ad811] {\n    grid-area: history-labels;\n    -ms-flex-item-align: end;\n        align-self: end;\n    margin-top: 12px\n}\n.column-labels ul[data-v-335ad811] {\n  display: grid;\n  list-style: none;\n  text-align: left;\n  font-weight: 600;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  padding: 0px 4px;\n}\n.selected[data-v-335ad811] {\n  border: 3px  solid var(--green);\n}\n.history-container[data-v-335ad811] {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  grid-auto-rows: 54px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  border-radius: 6px;\n  text-align: left;\n  background-color: var(--card-bg-theme-color);\n  -webkit-box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n          box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n  grid-area: transactions;\n  padding-bottom: 4px;\n  overflow: hidden;\n}\n.history-item[data-v-335ad811] {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  height: 54px;\n  border-bottom: 1px solid rgba(0, 69, 102, .1);\n  padding: 4px 16px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  text-align: left;\n  grid-column: 1 / -1\n}\n.history-item > h4[data-v-335ad811] {\n  font-weight: 400;\n}\n.coin-name > i[data-v-335ad811] {\n  margin-right: 4px;\n}\n"],"sourceRoot":""}]);
...
// load the styles
var content = __webpack_require__("66Ys");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("83dd3154", content, true);
    ...
    methods: {
        ...
        formatPrice: function (transaction) {
            if (transaction.amount > 0) {
                var adjustedPrice = transaction.amount * transaction.exchangeRates[this.selectedCurrency];
...
//# sourceMappingURL=app.7c13220be24a90934fb9.js.map