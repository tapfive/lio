...
// module
exports.push([module.i, ".portfolio-graph[data-v-80f2e722]{min-height:100vh;background-color:var(--view-bg-theme-color);background-image:var(--view-bg-theme-gradient);display:grid;grid-template-columns:1fr 200px 200px 200px 200px 1fr;grid-template-rows:96px 400px -webkit-min-content;grid-template-rows:96px 400px min-content;grid-auto-rows:96px;grid-gap:16px;grid-template-areas:\". time-picker     time-picker     time-picker     time-picker    .\" \". graph           graph           graph           graph          .\" \". options         options         options         options        .\"}button[data-v-80f2e722]{background-color:#fff}.time-range-picker[data-v-80f2e722]{grid-row:1/2;grid-column:2/6;grid-area:time-picker;-ms-flex-item-align:center;align-self:center}.line-chart[data-v-80f2e722]{grid-area:graph;height:220px;width:100%}.selected[data-v-80f2e722]{border:3px solid var(--green)}.options-wrapper[data-v-80f2e722]{grid-area:options;grid-row:auto;grid-row:3/4;grid-column:2/-2;display:grid;grid-template-columns:96px 96px 96px 96px 96px 96px 96px 96px;grid-template-rows:96px;grid-auto-rows:96px;grid-gap:16px}.options[data-v-80f2e722]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-item-align:center;align-self:center;justify-self:center}.options button[data-v-80f2e722]{width:72px;height:72px;border-radius:100px;font-size:18px}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioGraph.vue"],"names":[],"mappings":"AACA,kCACE,iBAAkB,AAClB,4CAA6C,AAC7C,+CAAgD,AAChD,aAAc,AACd,sDAAuD,AACvD,kDAAmD,AACnD,0CAA2C,AAC3C,oBAAqB,AACrB,cAAe,AACf,kOAGuE,CACxE,AACD,wBACE,qBAA0B,CAC3B,AACD,oCACE,aAAgB,AAChB,gBAAmB,AACnB,sBAAuB,AACvB,2BAA4B,AACxB,iBAAmB,CACxB,AACD,6BACI,gBAAiB,AACjB,aAAc,AACd,UAAY,CACf,AACD,2BACE,6BAA+B,CAChC,AACD,kCACE,kBAAmB,AACnB,cAAe,AACf,aAAgB,AAChB,iBAAoB,AACpB,aAAc,AACd,8DAA+D,AAC/D,wBAAyB,AACzB,oBAAqB,AACrB,aAAe,CAChB,AACD,0BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,2BAA2B,AACvB,kBAAkB,AACtB,mBAAoB,CACrB,AACD,iCACE,WAAY,AACZ,YAAa,AACb,oBAAqB,AACrB,cAAgB,CACjB","file":"PortfolioGraph.vue","sourcesContent":["\n.portfolio-graph[data-v-80f2e722] {\n  min-height: 100vh;\n  background-color: var(--view-bg-theme-color);\n  background-image: var(--view-bg-theme-gradient);\n  display: grid;\n  grid-template-columns: 1fr 200px 200px 200px 200px 1fr;\n  grid-template-rows: 96px 400px -webkit-min-content;\n  grid-template-rows: 96px 400px min-content;\n  grid-auto-rows: 96px;\n  grid-gap: 16px;\n  grid-template-areas:\n    \". time-picker     time-picker     time-picker     time-picker    .\"\n    \". graph           graph           graph           graph          .\"\n    \". options         options         options         options        .\";\n}\nbutton[data-v-80f2e722] {\n  background-color: #FFFFFF;\n}\n.time-range-picker[data-v-80f2e722] {\n  grid-row: 1 / 2;\n  grid-column: 2 / 6;\n  grid-area: time-picker;\n  -ms-flex-item-align: center;\n      align-self: center;\n}\n.line-chart[data-v-80f2e722] {\n    grid-area: graph;\n    height: 220px;\n    width: 100%;\n}\n.selected[data-v-80f2e722] {\n  border: 3px  solid var(--green)\n}\n.options-wrapper[data-v-80f2e722] {\n  grid-area: options;\n  grid-row: auto;\n  grid-row: 3 / 4;\n  grid-column: 2 / -2;\n  display: grid;\n  grid-template-columns: 96px 96px 96px 96px 96px 96px 96px 96px;\n  grid-template-rows: 96px;\n  grid-auto-rows: 96px;\n  grid-gap: 16px;\n}\n.options[data-v-80f2e722] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-flex-item-align:center;\n      align-self:center;\n  justify-self: center\n}\n.options button[data-v-80f2e722] {\n  width: 72px;\n  height: 72px;\n  border-radius: 100px;\n  font-size: 18px;\n}\n"],"sourceRoot":""}]);
...
// module
exports.push([module.i, ".portfolio-total[data-v-56f98cc8]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-top:24px;border-radius:11.2px;background-color:var(--card-bg-theme-color);-webkit-box-shadow:0 3px 76px -16px var(--shadow-theme-color);box-shadow:0 3px 76px -16px var(--shadow-theme-color);text-align:center;font-size:26px;grid-area:total}@media screen and (min-width:2000px){.dashboard-content[data-v-56f98cc8]{grid-area:total}}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioTotal.vue"],"names":[],"mappings":"AACA,kCACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAC/B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,wBAAyB,AACrB,qBAAsB,AAClB,uBAAwB,AAEhC,gBAAiB,AACjB,qBAAsB,AACtB,4CAA6C,AAC7C,8DAA+D,AACvD,sDAAuD,AAC/D,kBAAmB,AACnB,eAAgB,AAGhB,eAAiB,CAClB,AACD,qCACA,oCACM,eAAiB,CACtB,CACA","file":"PortfolioTotal.vue","sourcesContent":["\n.portfolio-total[data-v-56f98cc8] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  /* justify-self: center; */\n  margin-top: 24px;\n  border-radius: 11.2px;\n  background-color: var(--card-bg-theme-color);\n  -webkit-box-shadow: 0 3px 76px -16px var(--shadow-theme-color);\n          box-shadow: 0 3px 76px -16px var(--shadow-theme-color);\n  text-align: center;\n  font-size: 26px;\n  /* grid-column: 2 / 6;\n  grid-row: 2 /3; */\n  grid-area: total;\n}\n@media screen and (min-width: 2000px) {\n.dashboard-content[data-v-56f98cc8] {\n      grid-area: total;\n}\n}\n"],"sourceRoot":""}]);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ac5c90a_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioHistory_vue__ = __webpack_require__("VDuB");
function injectStyle (ssrContext) {
  __webpack_require__("DWg1")
}
...
/* scopeId */
var __vue_scopeId__ = "data-v-5ac5c90a"
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_5ac5c90a_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioHistory_vue__["a" /* default */],
...
// load the styles
var content = __webpack_require__("P/lD");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("a63f4a86", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_64cf75bc_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioOverview_vue__ = __webpack_require__("5Awv");
function injectStyle (ssrContext) {
  __webpack_require__("mhmh")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-64cf75bc"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_64cf75bc_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioOverview_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, (window.blockstack.putFile(STORAGE_FILE, JSON.stringify(newStorage), true))];
                    case 1:
                        _a.sent();
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 8]);
                        return [4 /*yield*/, (window.blockstack.getFile(STORAGE_FILE, true))];
                    case 2:
                        storageText = _a.sent();
                        return [3 /*break*/, 8];
                    case 3:
                    ...
                    case 4:
                        ...
                        return [4 /*yield*/, (window.blockstack.putFile(STORAGE_FILE, JSON.stringify(new __WEBPACK_IMPORTED_MODULE_0__models_storage_data__["a" /* StorageData */](STORAGE_VERSION)), true))];
                    case 5:
                        // If error was caused by trying to decrypt an empty file, create a new one
                        _a.sent();
                        return [3 /*break*/, 7];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, (window.blockstack.getFile(STORAGE_FILE, false))];
                    case 2:
...
// load the styles
var content = __webpack_require__("4Ogi");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("b71035ba", content, true, {});
...
// load the styles
var content = __webpack_require__("1w/b");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("30055a7a", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_56f98cc8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioTotal_vue__ = __webpack_require__("X6b+");
function injectStyle (ssrContext) {
  __webpack_require__("sD9b")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-56f98cc8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_56f98cc8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioTotal_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// load the styles
var content = __webpack_require__("zVn1");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("e21845ba", content, true, {});
...
// load the styles
var content = __webpack_require__("Vy31");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("f19e95bc", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_81853684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TransactionCoinItem_vue__ = __webpack_require__("O8rh");
function injectStyle (ssrContext) {
  __webpack_require__("vSvk")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-81853684"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_81853684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TransactionCoinItem_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2cea5684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioSidebar_vue__ = __webpack_require__("XAbl");
function injectStyle (ssrContext) {
  __webpack_require__("9uO9")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-2cea5684"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_2cea5684_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioSidebar_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// load the styles
var content = __webpack_require__("rK5w");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("4c5a5ff7", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_80f2e722_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioGraph_vue__ = __webpack_require__("l90D");
function injectStyle (ssrContext) {
  __webpack_require__("7vFN")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-80f2e722"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_80f2e722_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioGraph_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f24135f_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TheLanding_vue__ = __webpack_require__("ceGF");
function injectStyle (ssrContext) {
  __webpack_require__("K2tf")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-6f24135f"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_6f24135f_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TheLanding_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// load the styles
var content = __webpack_require__("lD4G");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("b28841aa", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05547109_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TimeIntervalPicker_vue__ = __webpack_require__("5MA+");
function injectStyle (ssrContext) {
  __webpack_require__("5EAs")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-05547109"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_05547109_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TimeIntervalPicker_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// load the styles
var content = __webpack_require__("S9jm");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("518f697f", content, true, {});
...
// load the styles
var content = __webpack_require__("eir9");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("b3c80c0a", content, true, {});
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4f0f1968_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__ = __webpack_require__("GxIJ");
function injectStyle (ssrContext) {
  __webpack_require__("oV6f")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_4f0f1968_hasScoped_false_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_App_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// module
exports.push([module.i, ".portfolio-overview[data-v-64cf75bc]{min-height:100vh;background-color:var(--view-bg-theme-color);background-image:var(--view-bg-theme-gradient)}.dashboard-content[data-v-64cf75bc]{display:grid;grid-template-columns:1fr 200px 200px 200px 200px 1fr;grid-template-rows:24px 242px 48px 96px;grid-auto-rows:96px;grid-gap:16px;grid-template-areas:\". time-picker     time-picker     time-picker     time-picker    .\" \". total           total           total           total          .\" \". balance-labels  balance-labels  balance-labels  balance-labels .\" \". balance         balance         balance         balance        .\"}@media screen and (max-width:1100px){.dashboard-content[data-v-64cf75bc]{grid-template-columns:.5fr minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) .5fr}}@media screen and (min-width:2000px){.dashboard-content[data-v-64cf75bc]{grid-template-columns:1fr 360px 360px 360px 360px 1fr}}.time-range-picker[data-v-64cf75bc]{grid-row:1/2;grid-column:2/6;grid-area:time-picker;-ms-flex-item-align:center;align-self:center}.column-labels[data-v-64cf75bc]{grid-area:balance-labels;-ms-flex-item-align:end;align-self:end;margin-top:12px}.column-labels ul[data-v-64cf75bc]{display:grid;list-style:none;text-align:left;font-weight:600;grid-template-columns:1fr 1fr 1fr 1fr;padding:0 32px}.balance-wrapper[data-v-64cf75bc]{grid-area:balance;grid-row:auto}.loading-container[data-v-64cf75bc]{position:fixed;top:50%;left:50%}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioOverview.vue"],"names":[],"mappings":"AACA,qCACE,iBAAkB,AAClB,4CAA6C,AAC7C,8CAAgD,CACjD,AACD,oCACE,aAAc,AACd,sDAAuD,AACvD,wCAAyC,AACzC,oBAAqB,AACrB,cAAe,AACf,uSAIuE,CACxE,AACD,qCACA,oCACI,mGAA2G,CAC9G,CACA,AACD,qCACA,oCACI,qDAAuD,CAC1D,CACA,AACD,oCACE,aAAgB,AAChB,gBAAmB,AACnB,sBAAuB,AACvB,2BAA4B,AACxB,iBAAmB,CACxB,AACD,gCACE,yBAA0B,AAC1B,wBAAyB,AACrB,eAAgB,AACpB,eAAgB,CACjB,AACD,mCACE,aAAc,AACd,gBAAiB,AACjB,gBAAiB,AACjB,gBAAiB,AACjB,sCAAuC,AACvC,cAAkB,CACnB,AACD,kCACE,kBAAmB,AACnB,aAAe,CAChB,AACD,oCACE,eAAgB,AAChB,QAAS,AACT,QAAU,CACX","file":"PortfolioOverview.vue","sourcesContent":["\n.portfolio-overview[data-v-64cf75bc] {\n  min-height: 100vh;\n  background-color: var(--view-bg-theme-color);\n  background-image: var(--view-bg-theme-gradient);\n}\n.dashboard-content[data-v-64cf75bc] {\n  display: grid;\n  grid-template-columns: 1fr 200px 200px 200px 200px 1fr;\n  grid-template-rows: 24px 242px 48px 96px;\n  grid-auto-rows: 96px;\n  grid-gap: 16px;\n  grid-template-areas:\n    \". time-picker     time-picker     time-picker     time-picker    .\"\n    \". total           total           total           total          .\"\n    \". balance-labels  balance-labels  balance-labels  balance-labels .\"\n    \". balance         balance         balance         balance        .\";\n}\n@media screen and (max-width: 1100px) {\n.dashboard-content[data-v-64cf75bc] {\n    grid-template-columns: 0.5fr minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) 0.5fr;\n}\n}\n@media screen and (min-width: 2000px) {\n.dashboard-content[data-v-64cf75bc] {\n    grid-template-columns: 1fr 360px 360px 360px 360px 1fr;\n}\n}\n.time-range-picker[data-v-64cf75bc] {\n  grid-row: 1 / 2;\n  grid-column: 2 / 6;\n  grid-area: time-picker;\n  -ms-flex-item-align: center;\n      align-self: center;\n}\n.column-labels[data-v-64cf75bc] {\n  grid-area: balance-labels;\n  -ms-flex-item-align: end;\n      align-self: end;\n  margin-top: 12px\n}\n.column-labels ul[data-v-64cf75bc] {\n  display: grid;\n  list-style: none;\n  text-align: left;\n  font-weight: 600;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  padding: 0px 32px;\n}\n.balance-wrapper[data-v-64cf75bc] {\n  grid-area: balance;\n  grid-row: auto;\n}\n.loading-container[data-v-64cf75bc] {\n  position: fixed;\n  top: 50%;\n  left: 50%;\n}\n"],"sourceRoot":""}]);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_521d29f8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioBalance_vue__ = __webpack_require__("/lwt");
function injectStyle (ssrContext) {
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-521d29f8"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_521d29f8_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioBalance_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
// module
exports.push([module.i, ".portfolio-sidebar[data-v-2cea5684]{position:fixed;top:0;left:0;display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-pack:justify;-ms-flex-pack:justify;justify-content:space-between;padding-top:24px;padding-bottom:24px;-webkit-box-sizing:border-box;box-sizing:border-box;min-height:100vh;max-height:100vh;width:220px;height:100vh;background:var(--bg-theme-color)}h1[data-v-2cea5684],h3[data-v-2cea5684]{color:var(--font-theme-color)}.sidebar-logo[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;margin-bottom:32px}.sidebar-logo>h1[data-v-2cea5684]{margin-left:8px}.sidebar-user[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;margin-bottom:32px;font-size:14px}.sidebar-user .nc-icon-wrapper>ellipse[data-v-2cea5684],.sidebar-user .nc-icon-wrapper>path[data-v-2cea5684],.sidebar-user .nc-icon-wrapper>polygon[data-v-2cea5684]{fill:var(--icon-theme-color)}.sidebar-user .user-name-logout>a span[data-v-2cea5684]{margin-right:8px}a[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;color:var(--font-theme-color);text-decoration:none}a span[data-v-2cea5684]{margin-left:16px}.nav-links[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;cursor:pointer;margin-left:32px}.nav-links a[data-v-2cea5684]{padding-top:16px;padding-bottom:16px}.nav-links .nc-icon-wrapper>ellipse[data-v-2cea5684],.nav-links .nc-icon-wrapper>path[data-v-2cea5684],.nav-links .nc-icon-wrapper>polygon[data-v-2cea5684]{fill:var(--icon-theme-color)}.selected .nc-icon-wrapper>ellipse[data-v-2cea5684],.selected .nc-icon-wrapper>path[data-v-2cea5684],.selected .nc-icon-wrapper>polygon[data-v-2cea5684]{fill:var(--green)}.action-buttons[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;width:100%}.add-value-button[data-v-2cea5684]{width:80%;height:62px;margin-bottom:16px;font-weight:700;font-size:18px}.add-value-button[data-v-2cea5684],.subtract-value-button[data-v-2cea5684]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center;border-radius:6px;text-align:center;cursor:pointer}.subtract-value-button[data-v-2cea5684]{width:60%;height:36px;background-color:var(--dark-blue);color:#fff;font-weight:600;font-size:16px}.subtract-value-button[data-v-2cea5684]:hover{background-color:var(--red);color:var(--dark-blue)}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioSidebar.vue"],"names":[],"mappings":"AACA,oCACE,eAAgB,AAChB,MAAO,AACP,OAAO,AACP,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAE/B,yBAA0B,AACtB,sBAAuB,AACnB,8BAA+B,AACvC,iBAAkB,AAClB,oBAAqB,AACrB,8BAA+B,AACvB,sBAAuB,AAC/B,iBAAkB,AAClB,iBAAkB,AAClB,YAAa,AACb,aAAc,AACd,gCAAkC,CAGnC,AACD,wCACE,6BAA+B,CAChC,AACD,+BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC3B,wBAAyB,AACrB,qBAAsB,AAClB,uBAAwB,AACjC,kBAAmB,CAEpB,AACD,kCACE,eAAiB,CAClB,AACD,+BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAC9B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC7B,mBAAoB,AAEpB,cAAe,CAChB,AAOD,qKACE,4BAA8B,CAC/B,AACD,wDACE,gBAAkB,CACnB,AACD,mBACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,8BAA+B,AAC/B,oBAAqB,CACtB,AACD,wBACE,gBAAkB,CACnB,AACD,4BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAC/B,eAAgB,AAChB,gBAAiB,CAClB,AACD,8BACE,iBAAkB,AAClB,mBAAoB,CACrB,AAOD,4JACE,4BAA8B,CAC/B,AAWD,yJACE,iBAAmB,CACpB,AACD,iCACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAC/B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,UAAY,CACb,AACD,mCAUE,UAAW,AACX,YAAa,AACb,mBAAmB,AAGnB,gBAAiB,AACjB,cAAgB,CAEjB,AACD,2EAlBE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,wBAAyB,AACrB,qBAAsB,AAClB,uBAAwB,AAIhC,kBAAmB,AACnB,kBAAmB,AAGnB,cAAgB,CAqBjB,AAnBD,wCAUE,UAAW,AACX,YAAa,AAGb,kCAAmC,AACnC,WAAa,AACb,gBAAiB,AACjB,cAAgB,CAEjB,AACD,8CACI,4BAA6B,AAC7B,sBAAwB,CAC3B","file":"PortfolioSidebar.vue","sourcesContent":["\n.portfolio-sidebar[data-v-2cea5684] {\n  position: fixed;\n  top: 0;\n  left:0;\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  /* align-items: center; */\n  -webkit-box-pack: justify;\n      -ms-flex-pack: justify;\n          justify-content: space-between;\n  padding-top: 24px;\n  padding-bottom: 24px;\n  -webkit-box-sizing: border-box;\n          box-sizing: border-box;\n  min-height: 100vh;\n  max-height: 100vh;\n  width: 220px;\n  height: 100vh;\n  background: var(--bg-theme-color);\n  /* grid-area: sidebar; */\n  /* grid-column: 1 / 2; */\n}\nh1[data-v-2cea5684], h3[data-v-2cea5684] {\n  color: var(--font-theme-color);\n}\n.sidebar-logo[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n   -webkit-box-pack: center;\n       -ms-flex-pack: center;\n           justify-content: center;\n  margin-bottom: 32px\n  /*margin-left: 32px;*/\n}\n.sidebar-logo > h1[data-v-2cea5684] {\n  margin-left: 8px;\n}\n.sidebar-user[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n   -webkit-box-align: center;\n       -ms-flex-align: center;\n           align-items: center;\n  margin-bottom: 32px;\n  /*margin-left: 32px;*/\n  font-size: 14px\n}\n.sidebar-user .nc-icon-wrapper > path[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.sidebar-user .nc-icon-wrapper > ellipse[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.sidebar-user .nc-icon-wrapper > polygon[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.sidebar-user .user-name-logout > a span[data-v-2cea5684] {\n  margin-right: 8px;\n}\na[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  color: var(--font-theme-color);\n  text-decoration: none\n}\na span[data-v-2cea5684] {\n  margin-left: 16px;\n}\n.nav-links[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  cursor: pointer;\n  margin-left: 32px\n}\n.nav-links a[data-v-2cea5684] {\n  padding-top: 16px;\n  padding-bottom:16px;\n}\n.nav-links .nc-icon-wrapper > path[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.nav-links .nc-icon-wrapper > ellipse[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.nav-links .nc-icon-wrapper > polygon[data-v-2cea5684] {\n  fill: var(--icon-theme-color);\n}\n.selected[data-v-2cea5684] {\n  /* color: #FF0000; */\n  /* font-weight: 600; */\n}\n.selected .nc-icon-wrapper > path[data-v-2cea5684] {\n  fill: var(--green);\n}\n.selected .nc-icon-wrapper > ellipse[data-v-2cea5684] {\n  fill: var(--green);\n}\n.selected .nc-icon-wrapper > polygon[data-v-2cea5684] {\n  fill: var(--green);\n}\n.action-buttons[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  width: 100%;\n}\n.add-value-button[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  width: 80%;\n  height: 62px;\n  margin-bottom:16px;\n  border-radius: 6px;\n  text-align: center;\n  font-weight: 700;\n  font-size: 18px;\n  cursor: pointer;\n}\n.subtract-value-button[data-v-2cea5684] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n  width: 60%;\n  height: 36px;\n  border-radius: 6px;\n  text-align: center;\n  background-color: var(--dark-blue);\n  color: white;\n  font-weight: 600;\n  font-size: 16px;\n  cursor: pointer;\n}\n.subtract-value-button[data-v-2cea5684]:hover {\n    background-color: var(--red);\n    color: var(--dark-blue);\n}\n"],"sourceRoot":""}]);
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e1ff99a4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TransactionModal_vue__ = __webpack_require__("fGAf");
function injectStyle (ssrContext) {
  __webpack_require__("7sQB")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-e1ff99a4"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_e1ff99a4_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_TransactionModal_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f61f4ed_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThePortfolio_vue__ = __webpack_require__("zR6z");
function injectStyle (ssrContext) {
  __webpack_require__("Kt1B")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-7f61f4ed"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_7f61f4ed_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_ThePortfolio_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__storage_manager__ = __webpack_require__("6L/Q");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_settings__ = __webpack_require__("PUNY");
var __awaiter = (this && this.__awaiter) || function (thisArg, _arguments, P, generator) {
    return new (P || (P = Promise))(function (resolve, reject) {
        function fulfilled(value) { try { step(generator.next(value)); } catch (e) { reject(e); } }
        function rejected(value) { try { step(generator["throw"](value)); } catch (e) { reject(e); } }
...
var SettingsManager = /** @class */ (function () {
    function SettingsManager() {
        this.storageManager = __WEBPACK_IMPORTED_MODULE_0__storage_manager__["a" /* StorageManager */].getInstance();
        if (SettingsManager.instance) {
            throw new Error('Error: Instantiation failed: Use SettingsManager.getInstance() instead of new.');
        }
        SettingsManager.instance = this;
        this.settings = new __WEBPACK_IMPORTED_MODULE_1__models_settings__["a" /* Settings */]();
    }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3_luxon__ = __webpack_require__("H9QG");
...
var PriceManager = /** @class */ (function () {
    ...
    PriceManager.prototype.storeLatestPrice = function (prices) {
        return __awaiter(this, void 0, void 0, function () {
            var storage, _i, _a, item, error_1;
    ...
    PriceManager.prototype.getHistoricalPriceMinutes = function (coinSymbol, currency) {
        return __awaiter(this, void 0, void 0, function () {
            var storage, coinData, existingData, updatedPrices, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        if (!this.isPriceUpdateNeeded(existingData, currency, TimeInterval.MINUTES)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        this.storageManager.putStorage(storage);
                        _a.label = 3;
                    case 3: return [2 /*return*/, existingData];
                    case 4:
                        error_2 = _a.sent();
                        throw error_2;
    ...
    PriceManager.prototype.getHistoricalPriceHours = function (coinSymbol, amount, currency) {
        return __awaiter(this, void 0, void 0, function () {
            var storage, coinData, existingData, updatedPrices, error_3;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        if (!this.isPriceUpdateNeeded(existingData, currency, TimeInterval.HOURS)) return [3 /*break*/, 3];
                    ...
                    case 2:
                        ...
                        this.storageManager.putStorage(storage);
                        _a.label = 3;
                    case 3: return [2 /*return*/, this.getAmountNeeded(existingData, currency, amount)];
                    case 4:
                        error_3 = _a.sent();
                        throw error_3;
                    case 5: return [2 /*return*/];
    ...
    PriceManager.prototype.getHistoricalPriceDays = function (coinSymbol, amount, currency) {
        return __awaiter(this, void 0, void 0, function () {
            var storage, coinData, existingData, updatedPrices, error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                    ...
                    case 1:
                        ...
                        if (!this.isPriceUpdateNeeded(existingData, currency, TimeInterval.DAYS)) return [3 /*break*/, 3];
    ...
    PriceManager.prototype.isPriceUpdateNeeded = function (existingData, currency, interval) {
        var now = __WEBPACK_IMPORTED_MODULE_3_luxon__["DateTime"].local().toUTC();
        var lastTime = __WEBPACK_IMPORTED_MODULE_3_luxon__["DateTime"].fromMillis(existingData.lastTimeStamp * 1000);
    ...
    PriceManager.prototype.getAmountNeeded = function (existingData, currency, amount) {
        ...
        var historicalPrice = new __WEBPACK_IMPORTED_MODULE_1__models_historical_price__["a" /* HistoricalPrice */](existingData.lastTimeStamp, currency);
...
(function (TimeInterval) {
    TimeInterval[TimeInterval["MINUTES"] = 0] = "MINUTES";
    TimeInterval[TimeInterval["HOURS"] = 1] = "HOURS";
    TimeInterval[TimeInterval["DAYS"] = 2] = "DAYS";
...
// module
exports.push([module.i, ".hero-stuff[data-v-6f24135f]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:vertical;-webkit-box-direction:normal;-ms-flex-direction:column;flex-direction:column;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-webkit-box-pack:center;-ms-flex-pack:center;justify-content:center}.hero-stuff>h2[data-v-6f24135f]{font-weight:300;font-size:48px;color:#00ffa2}.hero-bg[data-v-6f24135f]{-webkit-transform:skewY(-8deg);transform:skewY(-8deg);-webkit-transform-origin:0;transform-origin:0;z-index:-1}.hero-bg-fade[data-v-6f24135f],.hero-bg[data-v-6f24135f]{width:100%;height:680px;background:#046;background-image:linear-gradient(-135deg,#046,#01324a);position:absolute;top:0;left:0}.hero-bg-fade[data-v-6f24135f]{opacity:.2;-webkit-transform:skewY(-5deg);transform:skewY(-5deg);-webkit-transform-origin:0;transform-origin:0;z-index:-2}.hero-logo[data-v-6f24135f]{margin-top:120px}button[data-v-6f24135f]{padding:24px;-webkit-box-shadow:2px 4px 24px -8px rgba(0,3,4,.8);box-shadow:2px 4px 24px -8px rgba(0,3,4,.8);text-transform:uppercase;font-size:24px}button[data-v-6f24135f]:hover{background:var(--light-green);-webkit-box-shadow:4px 16px 24px -16px rgba(0,3,4,.6);box-shadow:4px 16px 24px -16px rgba(0,3,4,.6);-webkit-transform:translateY(-1px);transform:translateY(-1px)}button[data-v-6f24135f]:active{background:#002a3f;-webkit-box-shadow:4px 16px 24px -16px rgba(0,3,4,.8);box-shadow:4px 16px 24px -16px rgba(0,3,4,.8);color:#00ffa2;-webkit-transform:translateY(1px);transform:translateY(1px)}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/TheLanding.vue"],"names":[],"mappings":"AAIA,6BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,4BAA6B,AAC7B,6BAA8B,AAC1B,0BAA2B,AACvB,sBAAuB,AAC/B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,wBAAyB,AACrB,qBAAsB,AAClB,sBAAwB,CACjC,AACD,gCACE,gBAAiB,AACjB,eAAgB,AAChB,aAAe,CAChB,AACD,0BAKE,+BAAgC,AACxB,uBAAwB,AAChC,2BAA4B,AACpB,mBAAoB,AAI5B,UAAY,CACb,AACD,yDAbE,WAAY,AACZ,aAAc,AACd,gBAAoB,AACpB,uDAAqE,AAKrE,kBAAmB,AACnB,MAAO,AACP,MAAQ,CAiBT,AAdD,+BAKE,WAAa,AACb,+BAAgC,AACxB,uBAAwB,AAChC,2BAA4B,AACpB,mBAAoB,AAI5B,UAAY,CACb,AACD,4BACE,gBAAkB,CACnB,AACD,wBACE,aAAmB,AACnB,oDAAwD,AAChD,4CAAgD,AACxD,yBAA0B,AAC1B,cAAgB,CACjB,AACD,8BACI,8BAA+B,AAC/B,sDAA0D,AAClD,8CAAkD,AAC1D,mCAAoC,AAC5B,0BAA4B,CACvC,AACD,+BACI,mBAAoB,AACpB,sDAA0D,AAClD,8CAAkD,AAC1D,cAAe,AACf,kCAAmC,AAC3B,yBAA2B,CACtC","file":"TheLanding.vue","sourcesContent":["\n.landing[data-v-6f24135f] {\n  /* height: 100%; */\n}\n.hero-stuff[data-v-6f24135f]{\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: column;\n          flex-direction: column;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -webkit-box-pack: center;\n      -ms-flex-pack: center;\n          justify-content: center;\n}\n.hero-stuff > h2[data-v-6f24135f] {\n  font-weight: 300;\n  font-size: 48px;\n  color: #00FFA2;\n}\n.hero-bg[data-v-6f24135f] {\n  width: 100%;\n  height: 680px;\n  background: #004466;\n  background-image: linear-gradient(-135deg, #004466 0%, #01324A 100%);\n  -webkit-transform: skewY(-8deg);\n          transform: skewY(-8deg);\n  -webkit-transform-origin: 0;\n          transform-origin: 0;\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: -1;\n}\n.hero-bg-fade[data-v-6f24135f] {\n  width: 100%;\n  height: 680px;\n  background: #004466;\n  background-image: linear-gradient(-135deg, #004466 0%, #01324A 100%);\n  opacity: 0.2;\n  -webkit-transform: skewY(-5deg);\n          transform: skewY(-5deg);\n  -webkit-transform-origin: 0;\n          transform-origin: 0;\n  position: absolute;\n  top: 0;\n  left: 0;\n  z-index: -2;\n}\n.hero-logo[data-v-6f24135f] {\n  margin-top: 120px;\n}\nbutton[data-v-6f24135f] {\n  padding: 24px 24px;\n  -webkit-box-shadow: 2px 4px 24px -8px rgba(0, 3, 4, .8);\n          box-shadow: 2px 4px 24px -8px rgba(0, 3, 4, .8);\n  text-transform: uppercase;\n  font-size: 24px;\n}\nbutton[data-v-6f24135f]:hover{\n    background: var(--light-green);\n    -webkit-box-shadow: 4px 16px 24px -16px rgba(0, 3, 4, .6);\n            box-shadow: 4px 16px 24px -16px rgba(0, 3, 4, .6);\n    -webkit-transform: translateY(-1px);\n            transform: translateY(-1px);\n}\nbutton[data-v-6f24135f]:active{\n    background: #002A3F;\n    -webkit-box-shadow: 4px 16px 24px -16px rgba(0, 3, 4, .8);\n            box-shadow: 4px 16px 24px -16px rgba(0, 3, 4, .8);\n    color: #00FFA2;\n    -webkit-transform: translateY(1px);\n            transform: translateY(1px);\n}\n"],"sourceRoot":""}]);
...
// load the styles
var content = __webpack_require__("MXnu");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("5a5c0b7c", content, true, {});
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-a2b2ef94"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_vue__["default"].extend({
    ...
    methods: {
        ...
        addTransaction: function () {
            ...
            this.appData.transactionManager.storeTransaction(this.selectedItem, Number(this.amount) * multiplier, Number(this.price), Number(this.fees), 'USD', this.date)
                .then(function (response) {
                _this.$emit('reload');
            })
                .catch(function (error) {
...
// load the styles
var content = __webpack_require__("9Ce8");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("66174867", content, true, {});
...
// load the styles
var content = __webpack_require__("GNDO");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("846ea89a", content, true, {});
...
// module
exports.push([module.i, ".portfolio-history[data-v-5ac5c90a]{min-height:100vh;background-color:var(--view-bg-theme-color);background-image:var(--view-bg-theme-gradient);display:grid;grid-template-columns:1fr 200px 200px 200px 200px 1fr;grid-template-rows:96px 32px 96px 48px -webkit-min-content;grid-template-rows:96px 32px 96px 48px min-content;grid-gap:16px;grid-template-areas:\". history-title     history-title     history-title     history-title   .\" \". history-toggle-label . . . .\" \". history-toggles   history-toggles   history-toggles   history-toggles .\" \". history-labels    history-labels    history-labels    history-labels  .\" \". transactions      transactions      transactions      transactions    .\"}@media screen and (max-width:1100px){.portfolio-history[data-v-5ac5c90a]{grid-template-columns:.5fr minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) minmax(50px,1fr) .5fr}}@media screen and (min-width:2000px){.portfolio-history[data-v-5ac5c90a]{grid-template-columns:1fr 360px 360px 360px 360px 1fr}}.history-title[data-v-5ac5c90a]{grid-area:history-title}.toggles-label[data-v-5ac5c90a]{grid-area:history-toggle-label}.history-toggles-wrap[data-v-5ac5c90a]{grid-area:history-toggles;grid-template-columns:1fr 1fr 1fr 1fr;grid-row:auto;display:grid}.history-toggles[data-v-5ac5c90a]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:center;-ms-flex-align:center;align-items:center;-ms-flex-item-align:center;align-self:center;justify-self:center}.history-toggles button[data-v-5ac5c90a]{width:72px;height:72px;border-radius:100px;font-size:18px;background-color:#fff}.column-labels[data-v-5ac5c90a]{grid-area:history-labels;-ms-flex-item-align:end;align-self:end;margin-top:12px}.column-labels ul[data-v-5ac5c90a]{display:grid;list-style:none;text-align:left;font-weight:600;grid-template-columns:1fr 1fr 1fr 1fr 1fr;padding:0 4px}.selected[data-v-5ac5c90a]{border:3px solid var(--green)}.history-container[data-v-5ac5c90a]{grid-template-columns:1fr 1fr 1fr 1fr 1fr;grid-auto-rows:54px;border-radius:6px;background-color:var(--card-bg-theme-color);-webkit-box-shadow:0 2px 8px 0 var(--shadow-theme-color);box-shadow:0 2px 8px 0 var(--shadow-theme-color);grid-area:transactions;padding-bottom:4px;overflow:hidden}.history-container[data-v-5ac5c90a],.history-item[data-v-5ac5c90a]{display:grid;-webkit-box-align:center;-ms-flex-align:center;align-items:center;text-align:left}.history-item[data-v-5ac5c90a]{grid-template-columns:1fr 1fr 1fr 1fr 1fr;height:54px;border-bottom:1px solid rgba(0,69,102,.1);padding:4px 16px;grid-column:1/-1}.history-item>h4[data-v-5ac5c90a]{font-weight:400}.coin-name>i[data-v-5ac5c90a]{margin-right:4px}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioHistory.vue"],"names":[],"mappings":"AACA,oCACE,iBAAkB,AAClB,4CAA6C,AAC7C,+CAAgD,AAChD,aAAc,AACd,sDAAuD,AACvD,2DAA4D,AAC5D,mDAAoD,AACpD,cAAe,AACf,oWAK8E,CAC/E,AACD,qCACA,oCACI,mGAA2G,CAC9G,CACA,AACD,qCACA,oCACI,qDAAuD,CAC1D,CACA,AACD,gCACE,uBAAyB,CAC1B,AACD,gCACE,8BAAgC,CACjC,AACD,uCACE,0BAA2B,AAC3B,sCAAuC,AACvC,cAAe,AACf,YAAc,CACf,AACD,kCACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,8BAA+B,AAC/B,6BAA8B,AAC1B,uBAAwB,AACpB,mBAAoB,AAC5B,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,2BAA2B,AACvB,kBAAkB,AACtB,mBAAoB,CACrB,AACD,yCACE,WAAY,AACZ,YAAa,AACb,oBAAqB,AACrB,eAAgB,AAChB,qBAA0B,CAC3B,AACD,gCACI,yBAA0B,AAC1B,wBAAyB,AACrB,eAAgB,AACpB,eAAgB,CACnB,AACD,mCACE,aAAc,AACd,gBAAiB,AACjB,gBAAiB,AACjB,gBAAiB,AACjB,0CAA2C,AAC3C,aAAiB,CAClB,AACD,2BACE,6BAAgC,CACjC,AACD,oCAEE,0CAA2C,AAC3C,oBAAqB,AAIrB,kBAAmB,AAEnB,4CAA6C,AAC7C,yDAA0D,AAClD,iDAAkD,AAC1D,uBAAwB,AACxB,mBAAoB,AACpB,eAAiB,CAClB,AACD,mEAfE,aAAc,AAGd,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAE5B,eAAiB,CAmBlB,AAXD,+BAEE,0CAA2C,AAC3C,YAAa,AACb,0CAA8C,AAC9C,iBAAkB,AAKlB,gBAAmB,CACpB,AACD,kCACE,eAAiB,CAClB,AACD,8BACE,gBAAkB,CACnB","file":"PortfolioHistory.vue","sourcesContent":["\n.portfolio-history[data-v-5ac5c90a] {\n  min-height: 100vh;\n  background-color: var(--view-bg-theme-color);\n  background-image: var(--view-bg-theme-gradient);\n  display: grid;\n  grid-template-columns: 1fr 200px 200px 200px 200px 1fr;\n  grid-template-rows: 96px 32px 96px 48px -webkit-min-content;\n  grid-template-rows: 96px 32px 96px 48px min-content;\n  grid-gap: 16px;\n  grid-template-areas:\n    \". history-title     history-title     history-title     history-title   .\"\n    \". history-toggle-label . . . .\"\n    \". history-toggles   history-toggles   history-toggles   history-toggles .\"\n    \". history-labels    history-labels    history-labels    history-labels  .\"\n    \". transactions      transactions      transactions      transactions    .\";\n}\n@media screen and (max-width: 1100px) {\n.portfolio-history[data-v-5ac5c90a] {\n    grid-template-columns: 0.5fr minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) minmax(50px, 1fr) 0.5fr;\n}\n}\n@media screen and (min-width: 2000px) {\n.portfolio-history[data-v-5ac5c90a] {\n    grid-template-columns: 1fr 360px 360px 360px 360px 1fr;\n}\n}\n.history-title[data-v-5ac5c90a] {\n  grid-area: history-title;\n}\n.toggles-label[data-v-5ac5c90a] {\n  grid-area: history-toggle-label;\n}\n.history-toggles-wrap[data-v-5ac5c90a] {\n  grid-area: history-toggles;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  grid-row: auto;\n  display: grid;\n}\n.history-toggles[data-v-5ac5c90a] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  -ms-flex-item-align:center;\n      align-self:center;\n  justify-self: center\n}\n.history-toggles button[data-v-5ac5c90a] {\n  width: 72px;\n  height: 72px;\n  border-radius: 100px;\n  font-size: 18px;\n  background-color: #FFFFFF;\n}\n.column-labels[data-v-5ac5c90a] {\n    grid-area: history-labels;\n    -ms-flex-item-align: end;\n        align-self: end;\n    margin-top: 12px\n}\n.column-labels ul[data-v-5ac5c90a] {\n  display: grid;\n  list-style: none;\n  text-align: left;\n  font-weight: 600;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  padding: 0px 4px;\n}\n.selected[data-v-5ac5c90a] {\n  border: 3px  solid var(--green);\n}\n.history-container[data-v-5ac5c90a] {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  grid-auto-rows: 54px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  border-radius: 6px;\n  text-align: left;\n  background-color: var(--card-bg-theme-color);\n  -webkit-box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n          box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n  grid-area: transactions;\n  padding-bottom: 4px;\n  overflow: hidden;\n}\n.history-item[data-v-5ac5c90a] {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr 1fr;\n  height: 54px;\n  border-bottom: 1px solid rgba(0, 69, 102, .1);\n  padding: 4px 16px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  text-align: left;\n  grid-column: 1 / -1\n}\n.history-item > h4[data-v-5ac5c90a] {\n  font-weight: 400;\n}\n.coin-name > i[data-v-5ac5c90a] {\n  margin-right: 4px;\n}\n"],"sourceRoot":""}]);
...
// load the styles
var content = __webpack_require__("4jDT");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("02e19870", content, true, {});
...
// load the styles
var content = __webpack_require__("JUUF");
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__("rjj0")("52e7c6e7", content, true, {});
...
var AppData = /** @class */ (function () {
    function AppData() {
        this.storageManager = __WEBPACK_IMPORTED_MODULE_1__managers_storage_manager__["a" /* StorageManager */].getInstance();
        this.priceManager = __WEBPACK_IMPORTED_MODULE_2__managers_price_manager__["a" /* PriceManager */].getInstance();
        this.transactionManager = __WEBPACK_IMPORTED_MODULE_3__managers_transaction_manager__["a" /* TransactionManager */].getInstance();
        this.settingsManager = __WEBPACK_IMPORTED_MODULE_4__managers_settings_manager__["a" /* SettingsManager */].getInstance();
    ...
    AppData.prototype.loadSettings = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (this.settingsManager.loadSettings())];
                    case 1:
                        _a.sent();
                        return [2 /*return*/, true];
                }
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__models_coin_data__ = __webpack_require__("/Zv5");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__models_balance__ = __webpack_require__("N+9N");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__models_transaction__ = __webpack_require__("8OSg");
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__models_transaction_history__ = __webpack_require__("Sc2X");
...
var TransactionManager = /** @class */ (function () {
    ...
    TransactionManager.prototype.storeTransaction = function (coin, amount, price, fees, feeCurrency, date) {
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 4, , 5]);
                        formattedDate = date !== '' ? __WEBPACK_IMPORTED_MODULE_6_luxon__["DateTime"].fromISO(date).toISODate() : __WEBPACK_IMPORTED_MODULE_6_luxon__["DateTime"].local().toISODate();
                        return [4 /*yield*/, (__WEBPACK_IMPORTED_MODULE_0__api_currency_api__["a" /* default */].getExchangeRates(feeCurrency, formattedDate))];
                    case 1:
                    ...
                    case 2:
                        ...
                        transaction = new __WEBPACK_IMPORTED_MODULE_3__models_transaction__["a" /* Transaction */](amount, price, fees, exchangeRates, date);
    ...
    TransactionManager.prototype.getAllBalances = function () {
        return __awaiter(this, void 0, void 0, function () {
            var storage, balanceData, _i, _a, coinData, coinAmount, _b, _c, transaction, error_2;
                ...
                switch (_d.label) {
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = storage.coins; _i < _a.length; _i++) {
                            ...
                            if (coinAmount > 0) {
                                balanceData[coinData.coin.symbol] = new __WEBPACK_IMPORTED_MODULE_2__models_balance__["a" /* Balance */](coinData.coin, coinAmount, coinData.latestPrice);
                            }
                        }
    ...
    TransactionManager.prototype.getAllTransactions = function () {
        return __awaiter(this, void 0, void 0, function () {
            var storage, transactionData, index, _i, _a, coinData, _b, _c, transaction, error_3;
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        _d.trys.push([0, 2, , 3]);
                    ...
                    case 1:
                        ...
                        for (_i = 0, _a = storage.coins; _i < _a.length; _i++) {
                            ...
                            for (_b = 0, _c = coinData.transactions; _b < _c.length; _b++) {
                                transaction = _c[_b];
                                transactionData.push(new __WEBPACK_IMPORTED_MODULE_4__models_transaction_history__["a" /* TransactionHistory */](index, coinData.coin, transaction));
                                index++;
                            }
                        }
                        // Sort by date
                        transactionData.sort(function (firstItem, secondItem) {
                            ...
                            var firstDate = __WEBPACK_IMPORTED_MODULE_6_luxon__["DateTime"].fromISO(firstItem.transaction.date).valueOf();
                            var secondDate = __WEBPACK_IMPORTED_MODULE_6_luxon__["DateTime"].fromISO(secondItem.transaction.date).valueOf();
    ...
    TransactionManager.prototype.addTransactionForCoin = function (storage, coin, transaction) {
        ...
        storage.coins.push(new __WEBPACK_IMPORTED_MODULE_1__models_coin_data__["a" /* CoinData */](coin, transaction));
    };
...
/* unused harmony namespace reexport */
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_431ed5f7_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioSettings_vue__ = __webpack_require__("3N8d");
function injectStyle (ssrContext) {
  __webpack_require__("nyYX")
}
var normalizeComponent = __webpack_require__("VU/8")
/* script */
...
var __vue_styles__ = injectStyle
/* scopeId */
var __vue_scopeId__ = "data-v-431ed5f7"
/* moduleIdentifier (server only) */
var __vue_module_identifier__ = null
var Component = normalizeComponent(
  ...
  __WEBPACK_IMPORTED_MODULE_1__node_modules_vue_loader_lib_template_compiler_index_id_data_v_431ed5f7_hasScoped_true_transformToRequire_video_src_source_src_img_src_image_xlink_href_buble_transforms_node_modules_vue_loader_lib_selector_type_template_index_0_PortfolioSettings_vue__["a" /* default */],
  __vue_template_functional__,
  __vue_styles__,
  __vue_scopeId__,
  __vue_module_identifier__
...
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_vue__["default"].extend({
    ...
    mounted: function () {
        ...
        this.appData.loadSettings()
            .then(function (response) {
            _this.selectedCurrency = _this.appData.settingsManager.getSelectedCurrency();
            _this.selectedCurrencySymbol = _this.appData.settingsManager.getSelectedCurrencySymbol();
            _this.selectedInterval = _this.appData.settingsManager.getTimeInterval();
        });
        ...
        refreshPrices: function () {
            ...
            if (coins.length > 0) {
                __WEBPACK_IMPORTED_MODULE_5__ts_api_coin_api__["a" /* default */].getPriceMultiple(coins)
                    ...
                    _this.appData.priceManager.storeLatestPrice(response);
...
// module
exports.push([module.i, ".portfolio-balance[data-v-521d29f8]{display:grid;grid-template-columns:1fr 1fr 1fr 1fr;padding:0 32px;-webkit-box-align:center;-ms-flex-align:center;align-items:center;height:96px;border-radius:6px;background-color:var(--card-bg-theme-color);-webkit-box-shadow:0 2px 8px 0 var(--shadow-theme-color);box-shadow:0 2px 8px 0 var(--shadow-theme-color);-webkit-transition:all .25s var(--ease-out-cubic);transition:all .25s var(--ease-out-cubic);-webkit-transform:translateY(0);transform:translateY(0)}.portfolio-balance[data-v-521d29f8]:hover{-webkit-transform:translateY(-4px);transform:translateY(-4px)}.coin-info[data-v-521d29f8]{display:-webkit-box;display:-ms-flexbox;display:flex;-webkit-box-orient:horizontal;-webkit-box-direction:normal;-ms-flex-direction:row;flex-direction:row;-webkit-box-align:center;-ms-flex-align:center;align-items:center}.coin-logo[data-v-521d29f8]{margin-right:16px;font-size:48px}.coin-name[data-v-521d29f8]{font-weight:600;font-size:26px}.coin-price[data-v-521d29f8]{font-weight:600;font-size:18px;font-family:Source Code Pro}.coin-value[data-v-521d29f8]{font-weight:900;font-size:24px}.coin-balance[data-v-521d29f8]{font-weight:600;font-size:18px;font-family:Source Code Pro}.coin-balance>span[data-v-521d29f8]{letter-spacing:.3px;font-weight:600;font-size:12px;font-family:Source Sans Pro;opacity:.5}", "", {"version":3,"sources":["/home/alec/dev/web/lio/src/components/PortfolioBalance.vue"],"names":[],"mappings":"AACA,oCACE,aAAc,AACd,sCAAuC,AACvC,eAAkB,AAClB,yBAA0B,AACtB,sBAAuB,AACnB,mBAAoB,AAC5B,YAAa,AACb,kBAAmB,AACnB,4CAA6C,AAC7C,yDAA0D,AAClD,iDAAkD,AAC1D,kDAAmD,AACnD,0CAA2C,AAC3C,gCAAmC,AAC3B,uBAA2B,CACpC,AACD,0CACE,mCAAoC,AAC5B,0BAA4B,CACrC,AACD,4BACE,oBAAqB,AACrB,oBAAqB,AACrB,aAAc,AACd,8BAA+B,AAC/B,6BAA8B,AAC1B,uBAAwB,AACpB,mBAAoB,AAC5B,yBAA0B,AACtB,sBAAuB,AACnB,kBAAoB,CAC7B,AACD,4BACE,kBAAkB,AAClB,cAAgB,CACjB,AACD,4BACE,gBAAiB,AACjB,cAAgB,CACjB,AACD,6BACE,gBAAiB,AACjB,eAAgB,AAChB,2BAA+B,CAChC,AACD,6BACE,gBAAiB,AACjB,cAAgB,CACjB,AACD,+BACE,gBAAiB,AACjB,eAAgB,AAChB,2BAA+B,CAChC,AACD,oCACE,oBAAsB,AACtB,gBAAiB,AACjB,eAAgB,AAChB,4BAA+B,AAC/B,UAAa,CACd","file":"PortfolioBalance.vue","sourcesContent":["\n.portfolio-balance[data-v-521d29f8] {\n  display: grid;\n  grid-template-columns: 1fr 1fr 1fr 1fr;\n  padding: 0px 32px;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n  height: 96px;\n  border-radius: 6px;\n  background-color: var(--card-bg-theme-color);\n  -webkit-box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n          box-shadow: 0 2px 8px 0 var(--shadow-theme-color);\n  -webkit-transition: all .25s var(--ease-out-cubic);\n  transition: all .25s var(--ease-out-cubic);\n  -webkit-transform: translateY(0px);\n          transform: translateY(0px);\n}\n.portfolio-balance[data-v-521d29f8]:hover {\n  -webkit-transform: translateY(-4px);\n          transform: translateY(-4px);\n}\n.coin-info[data-v-521d29f8] {\n  display: -webkit-box;\n  display: -ms-flexbox;\n  display: flex;\n  -webkit-box-orient: horizontal;\n  -webkit-box-direction: normal;\n      -ms-flex-direction: row;\n          flex-direction: row;\n  -webkit-box-align: center;\n      -ms-flex-align: center;\n          align-items: center;\n}\n.coin-logo[data-v-521d29f8] {\n  margin-right:16px;\n  font-size: 48px;\n}\n.coin-name[data-v-521d29f8] {\n  font-weight: 600;\n  font-size: 26px;\n}\n.coin-price[data-v-521d29f8] {\n  font-weight: 600;\n  font-size: 18px;\n  font-family: 'Source Code Pro';\n}\n.coin-value[data-v-521d29f8] {\n  font-weight: 900;\n  font-size: 24px;\n}\n.coin-balance[data-v-521d29f8] {\n  font-weight: 600;\n  font-size: 18px;\n  font-family: 'Source Code Pro';\n}\n.coin-balance > span[data-v-521d29f8]{\n  letter-spacing: 0.3px;\n  font-weight: 600;\n  font-size: 12px;\n  font-family: 'Source Sans Pro';\n  opacity: 0.5;\n}\n"],"sourceRoot":""}]);
...
//# sourceMappingURL=app.183bbe83349900078f50.js.map